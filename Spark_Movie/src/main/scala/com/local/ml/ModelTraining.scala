...
object ModelTraining extends App {
  ...
  def main(args: Array[String]) {
    ...
    bestModel.save(sc, "model/") //保存模型

    println("The best model was trained with rank= " + bestRank + " and lamba= " + bestLamba + ", and numIter= " + bestNumIter + ", and its RMSE on the test set is " + testRmse + ".")
